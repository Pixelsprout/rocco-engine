platform ""
    requires {} {
        ...
        view : Model -> { camera_target : { x : F32, y : F32, z : F32 }, draws : List({ id : U64, mesh : U32, pos : { x : F32, y : F32, z : F32 }, scale : { x : F32, y : F32, z : F32 }, yaw : F32, tint : { x : F32, y : F32, z : F32 } }) },
    }
    exposes []
...
Scene : { camera_target : Vec3, draws : List({ id : U64, mesh : U32, pos : Vec3, scale : Vec3, yaw : F32, tint : Vec3 }) }
...
view_for_host : Box(Model) -> { camera_target : { x : F32, y : F32, z : F32 }, draws : List({ id : U64, mesh : U32, pos : { x : F32, y : F32, z : F32 }, scale : { x : F32, y : F32, z : F32 }, yaw : F32, tint : { x : F32, y : F32, z : F32 } }) }
